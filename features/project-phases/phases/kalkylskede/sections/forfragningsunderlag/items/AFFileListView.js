...
export default function AFFileListView({ companyId, project, afRelativePath = '', setAfRelativePath = null, afSelectedItemId = null, setAfSelectedItemId = null, bumpAfMirrorRefreshNonce = null }) {
  ...
  return (
    <SharePointFolderFileArea
      ...
      onRelativePathChange={typeof setAfRelativePath === 'function' ? setAfRelativePath : null}
      selectedItemId={afSelectedItemId}
      onSelectedItemIdChange={typeof setAfSelectedItemId === 'function' ? setAfSelectedItemId : null}
      onDidMutate={typeof bumpAfMirrorRefreshNonce === 'function' ? bumpAfMirrorRefreshNonce : null}
    />
  );
}
