...
const MainLayout = ({ children, onSelectProject, rightPanel = null, sidebarTitle, sidebarSearchPlaceholder, sidebarCompaniesMode, sidebarShowMembers = false, topBar = null, sidebarRestrictCompanyId = null, sidebarHideCompanyActions = false, sidebarAutoExpandMembers = false, sidebarSearchMembersOnly = false, sidebarAllowCompanyManagementActions = true, sidebarTemplatesMode = false, sidebarTemplatesVersion = 0, sidebarIconName = null, sidebarIconColor = null, sidebarControlTypesMode = false }) => {
    ...
    <div style={{ minHeight: '100vh', background: '#f4f6fa', fontFamily: 'Inter_400Regular, Inter, Arial, sans-serif' }}>
      ...
      <div style={{ display: 'flex', minHeight: `calc(100vh - ${topBarHeight}px)` }}>
        <ProjectSidebar
          ...
          templatesMode={sidebarTemplatesMode}
          templatesVersion={sidebarTemplatesVersion}
